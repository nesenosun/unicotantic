...
class Engelliler extends StatefulWidget {
  String gelenKullaniciEmail;

  Engelliler({required this.gelenKullaniciEmail});

  @override
  State<Engelliler> createState() => _EngellilerState();
}

class _EngellilerState extends State<Engelliler> {
                    ...
                    builder: (BuildContext context, AsyncSnapshot asyncSnapshot) {
                      if (asyncSnapshot.hasError) {
                        ...
                        if (asyncSnapshot.hasData) {
                          dynamic arkadaslar = asyncSnapshot.data.data()['engelledim'];
