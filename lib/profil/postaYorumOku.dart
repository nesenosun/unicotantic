...
import 'package:unicotantic/profil/postaYorumMetinGir.dart';
...
import '../Unic/fonksiyonlar/controllerFnksiyon.dart';
import '../Unic/fonksiyonlar/controllerNet.dart';
...
import '../Unic/fonksiyonlar/profilResmiGetir.dart';
import '../Unic/fonksiyonlar/videoPlayrFlick.dart';
import 'BenDrawer.dart';

class PostaYorumOku extends StatefulWidget {
  final gelenKullaniciEmail;
  final postAydi;

  PostaYorumOku({required this.gelenKullaniciEmail, required this.postAydi});

  @override
  State<PostaYorumOku> createState() => _PostaYorumOkuState();
}

class _PostaYorumOkuState extends State<PostaYorumOku> {
      ...
      child: Scaffold(
        ...
        body: Stack(
          children: [
            ...
            PostaYorumMetinGir(gelenKullaniciEmail: widget.gelenKullaniciEmail, postAydi: widget.postAydi),
          ],
        ),
      ),
    );
