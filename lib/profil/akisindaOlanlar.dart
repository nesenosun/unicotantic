...
class AkisindaOlanlar extends StatefulWidget {
  String gelenKullaniciEmail;

  AkisindaOlanlar({required this.gelenKullaniciEmail});

  @override
  State<AkisindaOlanlar> createState() => _AkisindaOlanlarState();
}

class _AkisindaOlanlarState extends State<AkisindaOlanlar> {
