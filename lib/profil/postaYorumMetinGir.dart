...
class PostaYorumMetinGir extends StatefulWidget {
  final gelenKullaniciEmail;
  final postAydi;

  PostaYorumMetinGir({required this.gelenKullaniciEmail, required this.postAydi});

  @override
  State<PostaYorumMetinGir> createState() => _PostaYorumMetinGirState();
}

class _PostaYorumMetinGirState extends State<PostaYorumMetinGir> {
