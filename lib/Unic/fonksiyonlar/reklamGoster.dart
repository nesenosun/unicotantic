  ...
  void showRewardedAd() {
    if (rewardedAd != null) {
      ...
      rewardedAd!.show(onUserEarnedReward: (AdWithoutView ad, RewardItem reward) {
        ...
        Get.off(const DoluAkisAnaSayfa());
      });
    }
  }
          ...
          children: [
            Padding(
              ...
              child: Text(
                ...
                style: TextStyle(
                    fontWeight: FontWeight.bold, fontSize: 14, fontFamily: "Montserrat", color: Colors.black87),
              ),
            ),
              ...
              child: Column(
                children: [
                  ...
                  Text(
                    ...
                    textAlign: TextAlign.center,
                    style: TextStyle(
                        fontWeight: FontWeight.bold, fontSize: 18, fontFamily: "Montserrat", color: Colors.black),
                  ),
                ],
              ),
            ),
