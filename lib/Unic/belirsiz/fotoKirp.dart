...
//
// class FoToKirp extends StatelessWidget {
//   const FoToKirp({Key? key}) : super(key: key);
//
...
//       home: const HomePage(title: 'Fotoğraf Yükle'),
//     );
//   }
// }
//
...
//       UploadTask yuklemeGorevi = referansYol.putFile(_pickedFile as File);
//       String url = await (await yuklemeGorevi).ref.getDownloadURL();
//       setState(() {
//         _pickedFile = url as XFile?;
//         getbox.write('profilresmilinki', _pickedFile.toString());
//
//         FirebaseFirestore.instance.collection('Kullanicilar').doc(kullanici.email.toString()).update({
//           'profilresmilinki': _pickedFile.toString(),
//         });
//       });
//     }
//   }
...
//         .child(kullanici.email.toString())
//         .child('profilresimleri')
//         .child('${DateTime.now().second}profilResmifdhfhsfhsfhf.png');
//     UploadTask yuklemeGorevi = referansYol.putFile(_pickedFile as File);
//     String url = await (await yuklemeGorevi).ref.getDownloadURL();
//     setState(() {
