...
///////////////////////////////////
class ZiyaretciProfilYorumBolumu extends StatefulWidget {
  String gelenKullaniciEmail;

  ZiyaretciProfilYorumBolumu({required this.gelenKullaniciEmail});

  @override
  State<ZiyaretciProfilYorumBolumu> createState() => _ZiyaretciProfilYorumBolumuState();
}

class _ZiyaretciProfilYorumBolumuState extends State<ZiyaretciProfilYorumBolumu> {
  ...
  Widget build(BuildContext context) {
    ...
    Query postlarSorgu = controllerNet.firestore.collection('postaYorum').orderBy("zaman", descending: true).limit(100);
                                      ...
                                      child: Card(
                                        ...
                                        child: Padding(
                                          ...
                                          child: Text(
                                              ...
                                              isim.toString() + ' ' + soyisim.toString() + ' Yorumlar',
                                              textAlign: TextAlign.center),
                                        ),
                                      ),
                                    ),
