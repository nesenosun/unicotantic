...
// import 'package:unicotantic/Unic/girisEkrani/splash.dart';
//
// import 'email_giris_ekrani.dart';
...
//     }
//
//     await FirebaseFirestore.instance.collection("Kullanicilar").doc(_usernameController.text).update({
//       'id': '.....',
//       'uid': 'abcdefghijklmnoprst',
//     }).whenComplete(() => Navigator.pushAndRemoveUntil(
//         context, MaterialPageRoute(builder: (_) => const Splash()), (Route<dynamic> route) => false));
//   }
//
//   @override
//   void initState() {
//     puanSa.put('uygulama25', 25);
//     puanSa.put('uygulamaSurumu', 25);
