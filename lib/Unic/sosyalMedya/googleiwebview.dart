...
class GoogleiWeb extends StatefulWidget {
  const GoogleiWeb({super.key});

  @override
  State<GoogleiWeb> createState() => _GoogleiWebState();
}

class _GoogleiWebState extends State<GoogleiWeb> {
...
Page resource error:
  ...
  isForMainFrame: ${error.isForMainFrame}
      ...
      ..loadRequest(Uri.parse('https://www.google.com.tr/'));
