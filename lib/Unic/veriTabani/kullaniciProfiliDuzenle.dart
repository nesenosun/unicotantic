...
import '../fonksiyonlar/kullaniciProfilUstBar.dart';
import '../../profil/BenDrawer.dart';

class KullaniciProfiliDuzenle extends StatefulWidget {
  const KullaniciProfiliDuzenle({super.key});

  @override
  State<KullaniciProfiliDuzenle> createState() => _KullaniciProfiliDuzenleState();
}

class _KullaniciProfiliDuzenleState extends State<KullaniciProfiliDuzenle> {
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    textFieldMethod(isimC, Icons.account_circle_outlined, 'isim', isimEkle),
                    textFieldMethod(soyadC, Icons.account_circle, 'Soy isim', soyIsimEkle),
                    textFieldMethod(sehirC, Icons.location_city, 'Şehir', sehirEkle),
                    textFieldMethod(dogumTarihiC, Icons.cake_sharp, 'Doğum Tarihi', dogumTarihi),
                    textFieldMethod(iletisimC, Icons.accessibility_new_outlined, 'İletişim', iletisimEkle),
                    Padding(
