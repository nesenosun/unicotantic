...
class YorumaMetinGirDaktilo extends StatefulWidget {
  final gelenKullaniciEmail;
  final postAydi;

  YorumaMetinGirDaktilo({required this.gelenKullaniciEmail, required this.postAydi});

  @override
  State<YorumaMetinGirDaktilo> createState() => _YorumaMetinGirDaktiloState();
}

class _YorumaMetinGirDaktiloState extends State<YorumaMetinGirDaktilo> {
...
// Resmin boyutunu alın
  ...
  metinEkle() async {
    ...
    await FirebaseFirestore.instance.collection("postaYorum").doc(kullanici.email.toString() + dtNow.toString()).set({
      'id': id.toString(),
  ...
  Widget build(BuildContext context) {
    ...
    print('postIcerik' + postIcerik.toString());
