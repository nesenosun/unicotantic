    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        Widget content = Scaffold(
          ...
          appBar: AppBar(
            backgroundColor: Colors.black,
            title: const Text('Arkadaşlar', style: TextStyle(color: Colors.white, fontSize: 18)),
            leading: IconButton(
            ...
            builder: (context, snapshot) {
                ...
                return Center(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text('Henüz arkadaşın yok', style: TextStyle(color: Colors.grey[500])),
                    ],
                  ),
                );
              }
              ...
              return ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  return ListTile(
                    onTap: () => Get.to(() => Ziyaretci(gelenKullaniciEmail: friendId)),
                    ...
                    subtitle: const Text('Arkadaş', style: TextStyle(color: Colors.grey, fontSize: 12)),
